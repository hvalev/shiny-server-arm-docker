...
Docker image hosting Shiny-Server for ARM (armv7/arm64) and AMD (amd64) architectures. The build features some fixes targeting ARM and is primarily intended to be deployed on SBCs such as raspberry pi. The latest image is build with R v4.0.3 and Shiny-Server v1.5.16.958.
